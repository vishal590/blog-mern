  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form className='flex flex-col gap-4'>
            ...
            <TextInput type='text' id='username' placeholder='username' defaultValue={currentUser.username} className='mb-2' />
            <TextInput type='text' id='email' placeholder='username' defaultValue={currentUser.email} className='mb-2' />
            <TextInput type='password' id='password' placeholder='password' className='mb-2' />
